...
import com.stylefeng.guns.trade.model.builder.*;
...
import com.stylefeng.guns.trade.service.impl.AlipayTradeServiceImpl;
import com.stylefeng.guns.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.stylefeng.guns.trade.utils.Utils;
import com.stylefeng.guns.trade.utils.ZxingUtils;
...
public class Main {
    ...
    public void test_trade_precreate() {
        ...
        String subject = "xxx影院xxx店当面付扫码消费";
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("E:/seats/qr-%s.png",
